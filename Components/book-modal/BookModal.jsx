...
const selectionRange = {
    ...
    <div className="fixed z-30 backdrop-blur top-0 left-0 min-h-full w-full shadow-lg">
      <div
        className="bg-slate-100 w-1/4 rounded-lg 
...
onChange={({selection})=> {
    ...
    Submit
        ...
        <Button onClick={handlePayment} disabled={isLoading} label="Submit" className="w-3/4 mx-auto cursor-pointer rounded-lg py-3 px-6 text-xl text-white bg-blue-500 transition-all hover:bg-blue-600" />
    </div>
