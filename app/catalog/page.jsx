  ...
  return (
    <div className="min-h-screen w-full">
      <div className="relative h-3/5 w-full">
        ...
        />
        <h3 className="absolute text-6xl capitalize font-semibold flex items-center justify-center top-0 bottom-0 left-0 right-0 text-white">
          Dubai
        </h3>
      </div>

      <div className="relative z-20 -mt-12 h-full w-full flex flex-col items-center">
        <form className="border w-2/3 h-28 border-slate-800 px-4 py-12 rounded-xl bg-blue-600 text-white flex justify-between items-center">
    ...
    <Button disabled={false} label="Search" 
    className="mt-6 px-6 py-2 text-[20px] text-white bg-blue-600 rounded-xl transition-all hover:bg-[#efefef]"
    />
        </form>
